		...
		<div class="mm_event">
					...
					<template #content>
						<ul>
							<li
								...
								:key="index"
							>
								<a :href="`#event_prod_section${index}`"><b>group title{{ index }}</b></a>
							</li>
						</ul>
					</template>
				</dropdown>
			...
			>
				...
				<div class="mm_event-reply-list">
					<h5><b><strong>{{ items.length }}</strong>개의 댓글이 있습니다</b></h5>
